...
class Extractor(object):
    ...
    def extraer_actuaciones(self,actuaciones):
        self.driver.find_element(By.XPATH,'//*[@id="mainContent"]/div/div/div/div[2]/div/div/div[2]/div[2]/div[1]/div/div/div[2]/div/div[5]').click()
...
if __name__ == "__main__":
    ...
    buscador.extraer_actuaciones(actuaciones)
